...
export interface GraviolaNonFungibleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface GraviolaNonFungible extends BaseContract {
  connect(runner?: ContractRunner | null): GraviolaNonFungible;
  waitForDeployment(): Promise<this>;

  interface: GraviolaNonFungibleInterface;
